...
if (Quotient == 0 and remainder != 0):
    print("b. The quotient is zero and remainder is non zero.")
elif (Quotient !=0 and Remainder == 0):
    print("b. The quotient is non zero and remainder is zero.")
elif (Quotient != 0 and Remainder != 0):
    print("b. The quotient and remainder both are non zero.")
else :
    print("b. The quotient and remainder both are zero.")
...
#creating object
student1 = Student("GAURAV GOYAL", 21103024)
